...
@Component({
  ...
  styles: [`
    ...
    .avatar { width: 64px; height: 64px; border-radius: 50%; background: #2d4a8a; color: #fff; display: flex; align-items: center; justify-content: center; font-size: 26px; font-weight: 700; flex-shrink: 0; }
    .info { flex: 1; h1 { font-size: 20px; font-weight: 700; color: #1a2744; margin: 0 0 4px; } p { color: #718096; font-size: 14px; margin: 2px 0; } .role { color: #3182ce !important; font-weight: 500; } }
    ...
    .stat-card { background: #fff; border-radius: 12px; padding: 20px; box-shadow: 0 2px 8px rgba(0,0,0,0.06); text-align: center; .num { font-size: 30px; font-weight: 700; color: #1a2744; &.blue { color: #3182ce; } &.green { color: #38a169; } &.orange { color: #dd6b20; } } .lbl { font-size: 13px; color: #718096; margin-top: 4px; } }
  `]
})
